                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        FadeAnimation(
                          ...
                          child: Container(
                            ...
                            child: TextField(
                              ...
                              decoration: InputDecoration(
                                  errorText: validatePassword(_confirmPasswordController.text),
                                  enabledBorder: InputBorder.none,
                                  border: InputBorder.none,
                                  prefixIcon: Icon(
                                    Icons.lock_open_outlined,
                        ...
                        FadeAnimation(
                          ...
                          child: TextButton(
                              onPressed: () => {
                                _authService.createUser(_nameController.text, _emailController.text, _passwordController.text),
                                ...
                                ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                                    content: Text('Create account successfully. Let Login!')))
                              },
                              child: Text(
                                "Sign Up",
                                style: TextStyle(
